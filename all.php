...
<?php $title = "Tất cả sản phẩm - Guitar Xì Gòn";
                ...
                <div class="col-lg-4 sidebar">
                    <form method="GET" action="all.php" id="filter-product-form">
                                            ...
                                            <li class="category-item">
                                                <div class="category-header">
                                                    <input class="form-check-input" type="checkbox" name="type[]"
                                                        value="<?= $t['id'] ?>" id="<?= $type_id ?>"
                                                        <?= in_array($t['id'], $selected_types) ? 'checked' : '' ?>>
                        ...
                        <div class="filter-group-actions mt-4">
                            ...
                            <a href="all.php" class="btn btn-outline-secondary w-100 py-2">
